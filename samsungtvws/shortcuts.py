...
# Aspect Ratio
	def aspect_ratio(self):
		self.remote.send('KEY_ASPECT')

	def picture_size(self):
		self.remote.send('KEY_PICTURE_SIZE')

	def aspect_ratio_43(self):
		self.remote.send('KEY_4_3')

	def aspect_ratio_169(self):
		self.remote.send('KEY_16_9')

	def aspect_ratio_34_alt(self):
		self.remote.send('KEY_EXT14')

	def aspect_ratio_169_alt(self):
		self.remote.send('KEY_EXT15')
...
# Channel Keys
	def channel_up(self):
		self.remote.send('KEY_CHUP')

	def channel_down(self):
		self.remote.send('KEY_CHDOWN')

	def previous_channel(self):
		self.remote.send('KEY_PRECH')

	def favorite_channels(self):
		self.remote.send('KEY_FAVCH')

	def channel_list(self):
		self.remote.send('KEY_CH_LIST')
	...
	def auto_program(self):
		self.remote.send('KEY_AUTO_PROGRAM')

	def magic_channel(self):
		self.remote.send('KEY_MAGIC_CHANNEL')

# Color Keys
	def green(self):
		self.remote.send('KEY_GREEN')

	def yellow(self):
		self.remote.send('KEY_YELLOW')

	def cyan(self):
		self.remote.send('KEY_CYAN')

	def red(self):
		self.remote.send('KEY_RED')
...
# Direction Keys
	def navigation_up(self):
		self.remote.send('KEY_UP')

	def navigation_down(self):
		self.remote.send('KEY_DOWN')

	def navigation_left(self):
		self.remote.send('KEY_LEFT')

	def navigation_right(self):
		self.remote.send('KEY_RIGHT')

	def navigation_returnback(self):
		self.remote.send('KEY_RETURN')

	def navigation_enter(self):
		self.remote.send('KEY_ENTER')
...
# Input Keys
	def source(self):
		self.remote.send('KEY_SOURCE')

	def component_1(self):
		self.remote.send('KEY_COMPONENT1')

	def component_2(self):
		self.remote.send('KEY_COMPONENT2')

	def av_1(self):
		self.remote.send('KEY_AV1')

	def av_2(self):
		self.remote.send('KEY_AV2')

	def av_3(self):
		self.remote.send('KEY_AV3')

	def s_video_1(self):
		self.remote.send('KEY_SVIDEO1')

	def s_video_2(self):
		self.remote.send('KEY_SVIDEO2')

	def s_video_3(self):
		self.remote.send('KEY_SVIDEO3')

	def hdmi(self):
		self.remote.send('KEY_HDMI')

	def hdmi_1(self):
		self.remote.send('KEY_HDMI1')

	def hdmi_2(self):
		self.remote.send('KEY_HDMI2')

	def hdmi_3(self):
		self.remote.send('KEY_HDMI3')

	def hdmi_4(self):
		self.remote.send('KEY_HDMI4')

	def fm_radio(self):
		self.remote.send('KEY_FM_RADIO')

	def dvi(self):
		self.remote.send('KEY_DVI')

	def dvr(self):
		self.remote.send('KEY_DVR')

	def tv(self):
		self.remote.send('KEY_TV')

	def analog_tv(self):
		self.remote.send('KEY_ANTENA')

	def digital_tv(self):
		self.remote.send('KEY_DTV')

# Media Keys
	def rewind(self):
		self.remote.send('KEY_REWIND')

	def stop(self):
		self.remote.send('KEY_STOP')

	def play(self):
		self.remote.send('KEY_PLAY')

	def fast_forward(self):
		self.remote.send('KEY_FF')

	def record(self):
		self.remote.send('KEY_REC')

	def pause(self):
		self.remote.send('KEY_PAUSE')

	def live(self):
		self.remote.send('KEY_LIVE')

	def fnkey_quick_replay(self):
		self.remote.send('KEY_QUICK_REPLAY')

	def fnkey_still_picture(self):
		self.remote.send('KEY_STILL_PICTURE')

	def fnkey_instant_replay(self):
		self.remote.send('KEY_INSTANT_REPLAY')

# Menus
	def menu(self):
		self.remote.send('KEY_MENU')

	def top_menu(self):
		self.remote.send('KEY_TOPMENU')

	def tools(self):
		self.remote.send('KEY_TOOLS')

	def home(self):
		self.remote.send('KEY_HOME')

	def contents(self):
		self.remote.send('KEY_CONTENTS')

	def guide(self):
		self.remote.send('KEY_GUIDE')

	def disc_menu(self):
		self.remote.send('KEY_DISC_MENU')

	def dvr_menu(self):
		self.remote.send('KEY_DVR_MENU')

	def help(self):
		self.remote.send('KEY_HELP')

# Misc Keys
	def three_d(self):
		self.remote.send('KEY_PANNEL_CHDOWN')

	def anynet(self):
		self.remote.send('KEY_ANYNET')

	def energy_saving(self):
		self.remote.send('KEY_ESAVING')

	def sleep_timer(self):
		self.remote.send('KEY_SLEEP')

	def dtv_signal(self):
		self.remote.send('KEY_DTV_SIGNAL')

# Modes
	def vcr_mode(self):
		self.remote.send('KEY_VCR_MODE')

	def catv_mode(self):
		self.remote.send('KEY_CATV_MODE')

	def dss_mode(self):
		self.remote.send('KEY_DSS_MODE')

	def tv_mode(self):
		self.remote.send('KEY_TV_MODE')

	def dvd_mode(self):
		self.remote.send('KEY_DVD_MODE')

	def stb_mode(self):
		self.remote.send('KEY_STB_MODE')

	def pc_mode(self):
		self.remote.send('KEY_PCMODE')

# Number Keys
	def key1(self):
		self.remote.send('KEY_1')

	def key2(self):
		self.remote.send('KEY_2')

	def key3(self):
		self.remote.send('KEY_3')

	def key4(self):
		self.remote.send('KEY_4')

	def key5(self):
		self.remote.send('KEY_5')

	def key6(self):
		self.remote.send('KEY_6')

	def key7(self):
		self.remote.send('KEY_7')

	def key8(self):
		self.remote.send('KEY_8')

	def key9(self):
		self.remote.send('KEY_9')

	def key0(self):
		self.remote.send('KEY_0')

# OSD
	def info(self):
		self.remote.send('KEY_INFO')

	def caption(self):
		self.remote.send('KEY_CAPTION')

	def clockdisplay(self):
		self.remote.send('KEY_CLOCK_DISPLAY')

	def setup_clock(self):
		self.remote.send('KEY_SETUP_CLOCK_TIMER')

	def subtitle(self):
		self.remote.send('KEY_SUB_TITLE')

# Other Keys
	def wheel_left(self):
		self.remote.send('KEY_WHEEL_LEFT')

	def wheel_right(self):
		self.remote.send('KEY_WHEEL_RIGHT')

	def adddel(self):
		self.remote.send('KEY_ADDDEL')

	def plus_100(self):
		self.remote.send('KEY_PLUS100')

	def ad(self):
		self.remote.send('KEY_AD')

	def link(self):
		self.remote.send('KEY_LINK')

	def turbo(self):
		self.remote.send('KEY_TURBO')

	def convergence(self):
		self.remote.send('KEY_CONVERGENCE')

	def device_connect(self):
		self.remote.send('KEY_DEVICE_CONNECT')

	def key_11(self):
		self.remote.send('KEY_11')

	def key_12(self):
		self.remote.send('KEY_12')

	def key_factory(self):
		self.remote.send('KEY_FACTORY')

	def key_3speed(self):
		self.remote.send('KEY_3SPEED')

	def key_rsurf(self):
		self.remote.send('KEY_RSURF')

	def ff_(self):
		self.remote.send('KEY_FF_')

	def rewind_(self):
		self.remote.send('KEY_REWIND_')

	def angle(self):
		self.remote.send('KEY_ANGLE')

	def reserved_1(self):
		self.remote.send('KEY_RESERVED1')

	def program(self):
		self.remote.send('KEY_PROGRAM')

	def bookmark(self):
		self.remote.send('KEY_BOOKMARK')

	def print(self):
		self.remote.send('KEY_PRINT')

	def clear(self):
		self.remote.send('KEY_CLEAR')

	def v_chip(self):
		self.remote.send('KEY_VCHIP')

	def repeat(self):
		self.remote.send('KEY_REPEAT')

	def door(self):
		self.remote.send('KEY_DOOR')

	def open(self):
		self.remote.send('KEY_OPEN')

	def dma(self):
		self.remote.send('KEY_DMA')

	def mts(self):
		self.remote.send('KEY_MTS')

	def dnie(self):
		self.remote.send('KEY_DNIe')

	def srs(self):
		self.remote.send('KEY_SRS')

	def convert_audio_mainsub(self):
		self.remote.send('KEY_CONVERT_AUDIO_MAINSUB')

	def mdc(self):
		self.remote.send('KEY_MDC')

	def sound_effect(self):
		self.remote.send('KEY_SEFFECT')

	def perpect_focus(self):
		self.remote.send('KEY_PERPECT_FOCUS')

	def caller_id(self):
		self.remote.send('KEY_CALLER_ID')

	def scale(self):
		self.remote.send('KEY_SCALE')

	def magic_bright(self):
		self.remote.send('KEY_MAGIC_BRIGHT')

	def w_link(self):
		self.remote.send('KEY_W_LINK')

	def dtv_link(self):
		self.remote.send('KEY_DTV_LINK')

	def application_list(self):
		self.remote.send('KEY_APP_LIST')

	def back_mhp(self):
		self.remote.send('KEY_BACK_MHP')

	def alternate_mhp(self):
		self.remote.send('KEY_ALT_MHP')

	def dnse(self):
		self.remote.send('KEY_DNSe')

	def rss(self):
		self.remote.send('KEY_RSS')

	def entertainment(self):
		self.remote.send('KEY_ENTERTAINMENT')

	def id_input(self):
		self.remote.send('KEY_ID_INPUT')

	def id_setup(self):
		self.remote.send('KEY_ID_SETUP')

	def any_view(self):
		self.remote.send('KEY_ANYVIEW')

	def ms(self):
		self.remote.send('KEY_MS')
	...
	def auto_format(self):
		self.remote.send('KEY_AUTO_FORMAT')

	def dnet(self):
		self.remote.send('KEY_DNET')
...
# Picture Mode
	def picture_mode(self):
		self.remote.send('KEY_PMODE')

	def picture_mode_panorama(self):
		self.remote.send('KEY_PANORAMA')

	def picture_mode_dynamic(self):
		self.remote.send('KEY_DYNAMIC')

	def picture_mode_standard(self):
		self.remote.send('KEY_STANDARD')

	def picture_mode_movie(self):
		self.remote.send('KEY_MOVIE1')

	def picture_mode_game(self):
		self.remote.send('KEY_GAME')

	def picture_mode_custom(self):
		self.remote.send('KEY_CUSTOM')

	def picture_mode_movie_alt(self):
		self.remote.send('KEY_EXT9')

	def picture_mode_standard_alt(self):
		self.remote.send('KEY_EXT10')

# Picture in Picture
	def pip_onoff(self):
		self.remote.send('KEY_PIP_ONOFF')

	def pip_swap(self):
		self.remote.send('KEY_PIP_SWAP')

	def pip_size(self):
		self.remote.send('KEY_PIP_SIZE')

	def pip_channel_up(self):
		self.remote.send('KEY_PIP_CHUP')

	def pip_channel_down(self):
		self.remote.send('KEY_PIP_CHDOWN')

	def pip_small(self):
		self.remote.send('KEY_AUTO_ARC_PIP_SMALL')

	def pip_wide(self):
		self.remote.send('KEY_AUTO_ARC_PIP_WIDE')

	def pip_bottom_right(self):
		self.remote.send('KEY_AUTO_ARC_PIP_RIGHT_BOTTOM')

	def pip_source_change(self):
		self.remote.send('KEY_AUTO_ARC_PIP_SOURCE_CHANGE')

	def pip_scan(self):
		self.remote.send('KEY_PIP_SCAN')

# Power Keys
	def power_off(self):
		self.remote.send('KEY_POWEROFF')

	def power_on(self):
		self.remote.send('KEY_POWERON')

	def power_toggle(self):
		self.remote.send('KEY_POWER')
...
# Teletext
	def teletext_mix(self):
		self.remote.send('KEY_TTX_MIX')

	def teletext_subface(self):
		self.remote.send('KEY_TTX_SUBFACE')

# Volume Keys
	def volume_up(self):
		self.remote.send('KEY_VOLUP')

	def volume_down(self):
		self.remote.send('KEY_VOLDOWN')

	def mute(self):
		self.remote.send('KEY_MUTE')

# Zoom
	def zoom_move(self):
		self.remote.send('KEY_ZOOM_MOVE')

	def zoom_in(self):
		self.remote.send('KEY_ZOOM_IN')

	def zoom_out(self):
		self.remote.send('KEY_ZOOM_OUT')

	def zoom_1(self):
		self.remote.send('KEY_ZOOM1')

	def zoom_2(self):
		self.remote.send('KEY_ZOOM2')
